#pragma once
#ifndef RENDER_RENDER_C_HPP
#define RENDER_RENDER_C_HPP
/**
 * @file render.hpp
...
render_c(const T& data, std::string& out) {
  out.clear();
  out.reserve(0);
...
render_c(const T& data) {
  std::string out;
  auto result = render_c(data, out);
