#pragma once
#ifndef RENDER_RENDER13_HPP
#define RENDER_RENDER13_HPP
/**
 * @file render.hpp
...
render13(const T& data, Sink& out) {
...
render13(const T& data) {
  std::string out;
  auto result = render13(data, out);
