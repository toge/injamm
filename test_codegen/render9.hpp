#pragma once
#ifndef RENDER_RENDER9_HPP
#define RENDER_RENDER9_HPP
/**
 * @file render.hpp
...
render9(const T& data, std::string& out) {
  out.clear();
  out.reserve(8);
...
render9(const T& data) {
  std::string out;
  auto result = render9(data, out);
