#pragma once
#ifndef RENDER_RENDER_EXT3_HPP
#define RENDER_RENDER_EXT3_HPP
/**
 * @file render.hpp
...
render_ext3(const T& data, std::string& out) {
  out.clear();
  out.reserve(5);
...
render_ext3(const T& data) {
  std::string out;
  auto result = render_ext3(data, out);
