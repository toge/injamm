#pragma once
#ifndef RENDER_RENDER_DRIFT_SUB1_HPP
#define RENDER_RENDER_DRIFT_SUB1_HPP
/**
 * @file render.hpp
...
render_drift_sub1(const T& data, Sink& out) {
  ...
  filter_substr(_filtered, 4294967295, 3);
...
render_drift_sub1(const T& data) {
  std::string out;
  auto result = render_drift_sub1(data, out);
...
#endif // RENDER_RENDER_DRIFT_SUB1_HPP
