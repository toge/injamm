#pragma once
#ifndef RENDER_RENDER_DRIFT_PAD_HPP
#define RENDER_RENDER_DRIFT_PAD_HPP
/**
 * @file render.hpp
...
render_drift_pad(const T& data, Sink& out) {
...
render_drift_pad(const T& data) {
  std::string out;
  auto result = render_drift_pad(data, out);
...
#endif // RENDER_RENDER_DRIFT_PAD_HPP
