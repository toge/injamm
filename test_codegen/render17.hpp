#pragma once
#ifndef RENDER_RENDER17_HPP
#define RENDER_RENDER17_HPP
/**
 * @file render.hpp
...
render17(const T& data, std::string& out) {
  out.clear();
  out.reserve(1);
  ...
  bool _bwd1 = false;
  if (_bwd1) _hi1 = std::min(_hi1, _lo1 + 100u);
  else _lo1 = (_hi1 > 100u ? std::max(_lo1, _hi1 - 100u) : _lo1);
...
render17(const T& data) {
  std::string out;
  auto result = render17(data, out);
