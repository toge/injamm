#pragma once
#ifndef RENDER_RENDER_DRIFT_SUB2_HPP
#define RENDER_RENDER_DRIFT_SUB2_HPP
/**
 * @file render.hpp
...
render_drift_sub2(const T& data, Sink& out) {
...
render_drift_sub2(const T& data) {
  std::string out;
  auto result = render_drift_sub2(data, out);
...
#endif // RENDER_RENDER_DRIFT_SUB2_HPP
