#pragma once
#ifndef RENDER_RENDER3_HPP
#define RENDER_RENDER3_HPP
/**
 * @file render.hpp
...
render3(const T& data, std::string& out) {
  out.clear();
  out.reserve(13);
...
render3(const T& data) {
  std::string out;
  auto result = render3(data, out);
