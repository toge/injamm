#pragma once
#ifndef RENDER_RENDER6_HPP
#define RENDER_RENDER6_HPP
/**
 * @file render.hpp
...
render6(const T& data, std::string& out) {
  out.clear();
  out.reserve(12);
  
  out += "Hello ";
  html_escape_append_value(out, data);
  out += " World";
...
render6(const T& data) {
  std::string out;
  auto result = render6(data, out);
