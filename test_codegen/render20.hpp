#pragma once
#ifndef RENDER_RENDER20_HPP
#define RENDER_RENDER20_HPP
/**
 * @file render.hpp
...
render20(const T& data, Sink& out) {
...
render20(const T& data) {
  std::string out;
  auto result = render20(data, out);
