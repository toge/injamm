#pragma once
#ifndef RENDER_RENDER_SORT_REV_HPP
#define RENDER_RENDER_SORT_REV_HPP
/**
 * @file render.hpp
...
render_sort_rev(const T& data, Sink& out) {
  ...
  if (_size1 > 0) {
    ...
    std::stable_sort(_sorted1.begin(), _sorted1.end(), std::greater<_elem_t1>{});
  }
...
render_sort_rev(const T& data) {
  std::string out;
  auto result = render_sort_rev(data, out);
...
#endif // RENDER_RENDER_SORT_REV_HPP
