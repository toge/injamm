#pragma once
#ifndef RENDER_RENDER_ROUND_HPP
#define RENDER_RENDER_ROUND_HPP
/**
 * @file render.hpp
...
render_round(const T& data, Sink& out) {
  ...
  filter_float_round(_filtered, 2);
...
render_round(const T& data) {
  std::string out;
  auto result = render_round(data, out);
