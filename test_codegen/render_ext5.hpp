#pragma once
#ifndef RENDER_RENDER_EXT5_HPP
#define RENDER_RENDER_EXT5_HPP
/**
 * @file render.hpp
...
render_ext5(const T& data, Sink& out) {
...
render_ext5(const T& data) {
  std::string out;
  auto result = render_ext5(data, out);
