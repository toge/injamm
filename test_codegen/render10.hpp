#pragma once
#ifndef RENDER_RENDER10_HPP
#define RENDER_RENDER10_HPP
/**
 * @file render.hpp
...
render10(const T& data, Sink& out) {
...
render10(const T& data) {
  std::string out;
  auto result = render10(data, out);
