#pragma once
#ifndef RENDER_RENDER_DRIFT_FCMP_HPP
#define RENDER_RENDER_DRIFT_FCMP_HPP
/**
 * @file render.hpp
...
render_drift_fcmp(const T& data, Sink& out) {
...
render_drift_fcmp(const T& data) {
  std::string out;
  auto result = render_drift_fcmp(data, out);
...
#endif // RENDER_RENDER_DRIFT_FCMP_HPP
