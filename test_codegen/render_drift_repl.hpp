#pragma once
#ifndef RENDER_RENDER_DRIFT_REPL_HPP
#define RENDER_RENDER_DRIFT_REPL_HPP
/**
 * @file render.hpp
...
render_drift_repl(const T& data, Sink& out) {
...
render_drift_repl(const T& data) {
  std::string out;
  auto result = render_drift_repl(data, out);
...
#endif // RENDER_RENDER_DRIFT_REPL_HPP
