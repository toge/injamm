#pragma once
#ifndef RENDER_RENDER_SORT_HPP
#define RENDER_RENDER_SORT_HPP
/**
 * @file render.hpp
...
render_sort(const T& data, Sink& out) {
...
render_sort(const T& data) {
  std::string out;
  auto result = render_sort(data, out);
