#pragma once
#ifndef RENDER_RENDER_EXT2_HPP
#define RENDER_RENDER_EXT2_HPP
/**
 * @file render.hpp
...
render_ext2(const T& data, std::string& out) {
  out.clear();
  out.reserve(13);
...
render_ext2(const T& data) {
  std::string out;
  auto result = render_ext2(data, out);
