#pragma once
#ifndef RENDER_RENDER_EXT1_HPP
#define RENDER_RENDER_EXT1_HPP
/**
 * @file render.hpp
...
render_ext1(const T& data, std::string& out) {
  out.clear();
  out.reserve(10);
...
render_ext1(const T& data) {
  std::string out;
  auto result = render_ext1(data, out);
